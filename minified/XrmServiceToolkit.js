XrmServiceToolkit = function () { }; XrmServiceToolkit.Common = function () {
    ...
    var alertMessage = function (message) { (window.parent.Xrm.Utility !== undefined && window.parent.Xrm.Utility.alertDialog !== undefined) ? window.parent.Xrm.Utility.alertDialog(message) : alert(message); }; var htmlEncode = function (s) {
        ...
        var _settings = ["<l:ContinueOnError>" + ContinueOnError.toString() + "</l:ContinueOnError>", "<l:ReturnResponses>" + ReturnResponses.toString() + "</l:ReturnResponses>"].join(""); var payload = []; for (var i = 0; i < requests.length; i++) { var request = requests[i].serialize(); payload.push(["<l:OrganizationRequest>", "<a:Parameters>", "<a:KeyValuePairOfstringanyType>", "<b:key>Target</b:key>", request, "</a:KeyValuePairOfstringanyType>", "</a:Parameters>", "<a:RequestId i:nil='true' />", "<a:RequestName>Create</a:RequestName>", "</l:OrganizationRequest>"].join("")); }
        return ["<request i:type='a:ExecuteMultipleRequest' xmlns:a=\"http://schemas.microsoft.com/xrm/2011/Contracts\"  xmlns:l=\"http://schemas.microsoft.com/xrm/2012/Contracts\">", "<a:Parameters xmlns:b=\"http://schemas.datacontract.org/2004/07/System.Collections.Generic\">", "<a:KeyValuePairOfstringanyType>", "<b:key>Requests</b:key>", ["<b:value i:type=\"l:OrganizationRequestCollection\">", payload.join(""), "</b:value>"].join(""), "</a:KeyValuePairOfstringanyType>", "<a:KeyValuePairOfstringanyType>", "<b:key>Settings</b:key>", (_settings == null) ? "<b:value i:nil=\"true\" />" : ["<b:value i:type=\"l:ExecuteMultipleSettings\">", _settings, "</b:value>"].join(""), "</a:KeyValuePairOfstringanyType>", "</a:Parameters>", "<a:RequestId i:nil=\"true\" />", "<a:RequestName>ExecuteMultiple</a:RequestName>", "</request>"].join("");
    }; var sCreateBatchUpdatePayload = function (requests, ContinueOnError, ReturnResponses) {
        var _settings = ["<l:ContinueOnError>" + ContinueOnError.toString() + "</l:ContinueOnError>", "<l:ReturnResponses>" + ReturnResponses.toString() + "</l:ReturnResponses>"].join(""); var payload = []; for (var i = 0; i < requests.length; i++) { var request = requests[i].serialize(); payload.push(["<l:OrganizationRequest>", "<a:Parameters>", "<a:KeyValuePairOfstringanyType>", "<b:key>Target</b:key>", request, "</a:KeyValuePairOfstringanyType>", "</a:Parameters>", "<a:RequestId i:nil='true' />", "<a:RequestName>Update</a:RequestName>", "</l:OrganizationRequest>"].join("")); }
        return ["<request i:type='a:ExecuteMultipleRequest' xmlns:a=\"http://schemas.microsoft.com/xrm/2011/Contracts\"  xmlns:l=\"http://schemas.microsoft.com/xrm/2012/Contracts\">", "<a:Parameters xmlns:b=\"http://schemas.datacontract.org/2004/07/System.Collections.Generic\">", "<a:KeyValuePairOfstringanyType>", "<b:key>Requests</b:key>", ["<b:value i:type=\"l:OrganizationRequestCollection\">", payload.join(""), "</b:value>"].join(""), "</a:KeyValuePairOfstringanyType>", "<a:KeyValuePairOfstringanyType>", "<b:key>Settings</b:key>", (_settings == null) ? "<b:value i:nil=\"true\" />" : ["<b:value i:type=\"l:ExecuteMultipleSettings\">", _settings, "</b:value>"].join(""), "</a:KeyValuePairOfstringanyType>", "</a:Parameters>", "<a:RequestId i:nil=\"true\" />", "<a:RequestName>ExecuteMultiple</a:RequestName>", "</request>"].join("");
    }; var sCreateBatchDeletePayload = function (EntitySchemanName, guids, ContinueOnError, ReturnResponses) {
        var _settings = ["<l:ContinueOnError>" + ContinueOnError.toString() + "</l:ContinueOnError>", "<l:ReturnResponses>" + ReturnResponses.toString() + "</l:ReturnResponses>"].join(""); var payload = []; for (var i = 0; i < guids.length; i++) { payload.push(["<l:OrganizationRequest><a:Parameters><a:KeyValuePairOfstringanyType><b:key>Target</b:key><b:value i:type='a:EntityReference'><a:Id>", guids[i].replace('{', '').replace('}', ''), "</a:Id><a:LogicalName>", EntitySchemanName, "</a:LogicalName><a:Name i:nil='true' /></b:value></a:KeyValuePairOfstringanyType></a:Parameters><a:RequestId i:nil='true' /><a:RequestName>Delete</a:RequestName></l:OrganizationRequest>"].join("")); }
        return ["<request i:type='a:ExecuteMultipleRequest' xmlns:a=\"http://schemas.microsoft.com/xrm/2011/Contracts\"  xmlns:l=\"http://schemas.microsoft.com/xrm/2012/Contracts\">", "<a:Parameters xmlns:b=\"http://schemas.datacontract.org/2004/07/System.Collections.Generic\">", "<a:KeyValuePairOfstringanyType>", "<b:key>Requests</b:key>", ["<b:value i:type=\"l:OrganizationRequestCollection\">", payload.join(""), "</b:value>"].join(""), "</a:KeyValuePairOfstringanyType>", "<a:KeyValuePairOfstringanyType>", "<b:key>Settings</b:key>", (_settings == null) ? "<b:value i:nil=\"true\" />" : ["<b:value i:type=\"l:ExecuteMultipleSettings\">", _settings, "</b:value>"].join(""), "</a:KeyValuePairOfstringanyType>", "</a:Parameters>", "<a:RequestId i:nil=\"true\" />", "<a:RequestName>ExecuteMultiple</a:RequestName>", "</request>"].join("");
    }; var execute = function (request, callback, errorCallback, passthroughObj, passthroughObj1) {
        var async = !!callback; return doRequest(request, "Execute", async, function (resultXml, errorMessage) {
            if ((resultXml == null) && (errorMessage != null) && (async)) {
                if (errorCallback) { errorCallback(errorMessage); } else { throw new Error(errorMessage); }
                return null;
            }
        ...
        var fetchXml = fetchCore.replace(/\"/g, "'"); var request = ["<request i:type='a:RetrieveMultipleRequest' xmlns:a='http://schemas.microsoft.com/xrm/2011/Contracts'>", "<a:Parameters xmlns:b='http://schemas.datacontract.org/2004/07/System.Collections.Generic'>", "<a:KeyValuePairOfstringanyType>", "<b:key>Query</b:key>", "<b:value i:type='a:FetchExpression'>", "<a:Query>", crmXmlEncode(fetchXml), "</a:Query>", "</b:value>", "</a:KeyValuePairOfstringanyType>", "</a:Parameters>", "<a:RequestId i:nil='true'/>", "<a:RequestName>RetrieveMultiple</a:RequestName>", "</request>"].join(""); var async = !!callback; return doRequest(request, "Execute", async, function (resultXml, errorMessage) {
            ...
            var fetchResult = selectSingleNode(resultXml, "//a:Entities"); var moreRecords = (selectSingleNodeText(resultXml, "//a:MoreRecords") === "true"); var fetchResults = []; if (fetchResult != null) {
                ...
                if (!async) { return fetchResults; } else { callback(fetchResults, moreRecords, pageCookie, passthroughObj, passthroughObj1); }
            }
        });
